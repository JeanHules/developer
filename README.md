# DoTopia OpenAPI Specification
[![Build Status](https://travis-ci.org/jeanhules/developer.svg?branch=master)](https://travis-ci.org/jeanhules/developer)
...
6. If you did everything correct, https://jeanhules.github.io/developer/ will lead to your new docs
...
- Documentation(ReDoc): https://jeanhules.github.io/developer/
- SwaggerUI: https://jeanhules.github.io/developer/swagger-ui/
- Look full spec:
    + JSON https://jeanhules.github.io/developer/swagger.json
    + YAML https://jeanhules.github.io/developer/swagger.yaml
- Preview spec version for branch `[branch]`: https://jeanhules.github.io/developer/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://jeanhules.github.io/developer/ with url from the message: `Server started <url>`
